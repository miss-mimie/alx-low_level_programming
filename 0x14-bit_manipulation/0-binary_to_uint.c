...
/**
 * binary_to_uint - this converts a binary to an unsigned integer
 * @b: the str containing the binary value to be converted
 *
...
unsigned int binary_to_uint(const char *b)
{
	...
	while (*b != '\0')
	{
		...
		/* this performs base 2 to base 10 arithmetic */
